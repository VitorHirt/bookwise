            ...
            <?php foreach ($books as $book): ?>
                ...
                >
                    <div class="bw-book-cover">
                        <button type="button" class="bw-fav-btn<?= !empty($book['is_favorite']) ? ' active' : '' ?>" title="Salvo" aria-label="Favoritar <?= htmlspecialchars($book['title'], ENT_QUOTES, 'UTF-8') ?>">
                            <i class="bi <?= !empty($book['is_favorite']) ? 'bi-heart-fill' : 'bi-heart' ?>"></i>
                        </button>
